...
// import { Users, CreditCard, Pill, MessageSquare, LogOut, Menu, X, Activity, User, Calendar, DollarSign, LifeBuoy, Package, HeartPulse } from 'lucide-react';
...
// type ActiveSection = 'users' | 'payments' | 'medications' | 'support' | 'overview' | 'appointments' | 'patients';
...
import AppointmentsManagement from './appointments';
import PatientsManagement from './patients';
import { getTotalSales, getTotalMedicines, getTotalAppointments, getTotalRevenue, getTotalPatients } from '../Api/countApi'; 
import { LineChart, Line, BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from 'recharts';
